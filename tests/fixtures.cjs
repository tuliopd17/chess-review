 ...
 * Os valores de eval foram escolhidos pra cair EXATAMENTE em cada faixa do
 * modelo oficial do chess.com (queda de win-prob), e as posições de sacrifício
...
// ----- Great: único lance à altura punindo um erro do oponente. -----
...
const greatMove = {
  ...
  best_eval_cp: 120,
  eval_after_cp: 120,
  second_best_eval_cp: -150, // folga grande pro 2º melhor
  is_capture: false,
  to: greatLine.to,
  net_material: 0,
};
const greatPrev = { classification: "blunder", is_capture: false, to: "z9" }; // oponente errou
...
const CLASSIFICATION_CASES = [
  ...
  { name: "good (loss ~0.041)", move: quiet(40, -5), prev: null, expected: "good" },
  { name: "inaccuracy (loss ~0.083)", move: quiet(40, -50), prev: null, expected: "inaccuracy" },
  ...
  { name: "great (pune erro do oponente)", move: greatMove, prev: greatPrev, expected: "great" },
];
